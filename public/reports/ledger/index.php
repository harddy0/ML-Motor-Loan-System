...
<div class="flex flex-col xl:flex-row justify-between items-end mb-8 gap-6">
    <div class="w-full xl:w-auto">
        <div class="mb-4">
            <h1 class="text-3xl font-black text-slate-800 tracking-tight uppercase">Ledger <span class="text-[#e11d48]">Reports</span></h1>
            <p class="text-[13px] font-bold text-slate-500 uppercase tracking-widest">Loan Account History</p>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                   <tr class="bg-slate-200 text-slate-800">
                        <th class="px-5 py-3 text-[14px] font-bold uppercase tracking-wider text-center border-r border-slate-300 w-24">Employee ID</th>
                        <th class="px-5 py-3 text-[14px] font-bold uppercase tracking-wider text-center border-r border-slate-300 w-24">Name</th>
                        <th class="px-5 py-3 text-[14px] font-bold uppercase tracking-wider text-center border-r border-slate-300 w-24">Granted Date</th>
                        <th class="px-5 py-3 text-[14px] font-bold uppercase tracking-wider text-center border-r border-slate-300 w-24">Maturity Date</th>
                        <th class="px-5 py-3 text-[14px] font-bold uppercase tracking-wider text-center border-r border-slate-300 w-24">Status</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-100">
                    <?php if (empty($borrowers)): ?>
                        <tr><td colspan="5" class="px-5 py-8 text-center text-[14px] font-bold text-slate-400 uppercase">No loans found in database.</td></tr>
                    <?php else: ?>
                        ...
                        <tr onclick="handleRowClick('<?= $row['loan_id'] ?>')" 
                            ...
                            <td class="px-5 py-4 text-[14px] font-bold text-slate-500 text-center border-r border-slate-100"><?= htmlspecialchars($row['maturity_date'] ?? '--') ?></td>

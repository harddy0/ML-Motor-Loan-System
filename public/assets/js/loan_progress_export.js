...
function printLoanProgress() {
    ...
    sortedRows.forEach((row) => {
        ...
        if (groupKey !== previousGroupKey) {
            groupedTableRows.push(`<tr class="group-row"><td colspan="8">${escapeHtml(groupKey)}</td></tr>`);
    ...
    const tableRows = groupedTableRows.join('') + `
        <tr class="summary-row">
            <td></td><td></td><td></td><td class="summary-label">TOTAL / AVG</td>
        ...
        <tr class="generated-row"><td colspan="8">Generated By: ${escapeHtml(generatedBy)}</td></tr>
        <tr class="generated-row generated-row-last"><td colspan="8">Generated Date and Time: ${escapeHtml(printedAt)}</td></tr>
    `;

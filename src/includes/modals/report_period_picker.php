...
// Handles switching the Green border between Coverage options
function updateCoverageStyles() {
    const boxes = document.querySelectorAll('.coverage-box');
    ...
    radios.forEach((radio, index) => {
        ...
        if (radio.checked) {
            // Apply Green styles to active selection
...
// Checks if Year and Month are picked to enable the button

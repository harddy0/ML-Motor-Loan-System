<div id="ledgerDetailModal" class="fixed inset-0 bg-white z-[60] hidden flex-col overflow-hidden text-[14px]">
    ...
    <div class="flex flex-col gap-2 w-full max-w-[160px] mt-20">
        ...
        <button id="btn-export-ledger" onclick="exportLedgerExcel()" 
            class="w-full py-2 bg-white border border-slate-200 text-slate-600 text-[11px] font-bold uppercase rounded-lg hover:bg-slate-50 transition-all flex justify-center items-center gap-2 mt-10">
        ...
        <div class="w-full border-t border-slate-200 pb-6">

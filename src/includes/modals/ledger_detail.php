<div id="ledgerDetailModal" class="fixed inset-0 bg-white z-[60] hidden flex-col overflow-hidden text-[14px]">
    ...
    <a href="javascript:void(0);" onclick="closeLedgerModal()" class="fixed top-2.5 right-6 group bg-white text-black hover:bg-slate-200 p-1 rounded-full border border-slate-100 transition-all shadow-md z-[70] flex items-center justify-center">

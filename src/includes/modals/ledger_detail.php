        ...
        <div class="bg-slate-50 border-b border-slate-200 px-6 py-4 shrink-0 shadow-sm z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 pt-2 mt-2">
                <div class="relative pl-4 border-l-2 border-slate/100 group hover:border-[#e11d48]/50 transition-colors duration-300">
                    <h4 class="text-[13px] font-black text-slate-800 uppercase tracking-[0.15em] mb-4">Reference</h4>
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-[13px] font-bold text-slate-400 uppercase tracking-tight">PN Number</span>
                            <span class="text-[13px] font-black text-slate-900 font-mono" id="modal-ledger-pn">--</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-[13px] font-bold text-slate-400 uppercase tracking-tight">Granted</span>
                            <span class="text-[13px] font-bold text-slate-600" id="modal-ledger-pndate">--</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-[13px] font-bold text-slate-400 uppercase tracking-tight">Maturity</span>
                            <span class="text-[13px] font-bold text-slate-600" id="modal-ledger-maturity">--</span>
                        </div>
                    </div>
                </div>

                <div class="relative pl-4 border-l-2 border-slate-100 group hover:border-[#e11d48]/50 transition-colors duration-300">
                    <h4 class="text-[13px] font-black text-slate-800 uppercase tracking-[0.15em] mb-4">Terms</h4>
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-[13px] font-bold text-slate-400 uppercase tracking-tight">Duration</span>
                            <span class="text-[13px] font-black text-slate-900" id="modal-ledger-terms">-- Months</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-[13px] font-bold text-slate-400 uppercase tracking-tight">Add-on Rate</span>
                            <div class="px-2 py-0.5 bg-slate-100 rounded text-[13px] font-black text-slate-700" id="modal-ledger-rate">--</div>
                        </div>
                    </div>
                </div>

                <div class="relative pl-4 border-l-2 border-slate-100 group hover:border-[#e11d48]/50 transition-colors duration-300">
                    <h4 class="text-[13px] font-black text-slate-800 uppercase tracking-[0.15em] mb-4">Financials</h4>
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-[13px] font-bold text-slate-400 uppercase tracking-tight">Principal</span>
                            <span class="text-[13px] font-black text-slate-900" id="modal-ledger-principal">--</span>
                        </div>
                        <div class="flex justify-between items-center ">
                            <span class="text-[13px] font-black text-[#e11d48] uppercase tracking-tighter">Amortization</span>
                            <span class="text-[13px] font-black text-[#e11d48]" id="modal-ledger-amort">--</span>
                        </div>
                    </div>
                </div>

            <div class="relative pl-4 border-l-2 border-slate-100 group hover:border-[#e11d48]/50 transition-colors duration-300">
                    <span class="text-[13px] font-black text-slate-800 uppercase tracking-[0.15em] mb-4">Account Status</span>
                    <div class="relative">
                        <span class="inline-flex items-center gap-1.5 px-4 py-2 bg-emerald-50 text-emerald-600 text-[13px] font-black uppercase rounded-full border border-emerald-100" id="modal-ledger-status">
                ...
                <div class="flex flex-col justify-center items-end text-right bg-slate-50 p-4 rounded-2xl">
                    <span class="text-[13px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">Principal Balance</span>
...
<!--end here-->
            ...
            <div class="w-full lg:w-72 bg-slate-50 flex flex-col shrink-0 border-t lg:border-t-0 z-10 shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.05)]">
                <div class="p-6 flex flex-col h-full">
                    <h3 class="text-[#e11d48] font-black text-[14px] uppercase tracking-widest border-b border-slate-200 pb-3 mb-4">Payment Summary</h3>
                    <div class="space-y-4 flex-1">
                        ...
                        <div class="bg-white p-4 rounded shadow-sm mt-2">
                            <span class="block text-[14px] font-bold text-slate-400 uppercase mb-1">Total Collected</span>

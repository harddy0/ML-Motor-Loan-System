        ...
        <form id="addBorrowerForm" class="p-8">
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="space-y-1">
                        <label class="text-[13px] text-slate-500">ID Number *</label>
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" name="reference_no" placeholder="REF-0000" class="w-full bg-white border border-slate-300 focus:border-slate-900 rounded-sm px-3 py-2 text-[13px] uppercase text-slate-800 outline-none">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="space-y-1">
                        ...
                        <input type="text" name="pn_number" id="pn_number" readonly placeholder="PN-2026-XXXX" class="w-full bg-slate-100 border border-slate-300 rounded-sm px-3 py-2 text-[13px] text-slate-500 outline-none cursor-not-allowed">
                    </div>
                    <div class="space-y-1">
                    ...
                    <div class="space-y-1">
                        <label class="text-[13px] text-slate-500">Maturity Date *</label>
                        <input type="date" name="pn_maturity" required class="w-full bg-white border border-slate-300 rounded-sm px-3 py-2 text-[13px] outline-none">
                    </div>
                </div>

                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 bg-slate-50/50 p-4 rounded-md border border-slate-100">
                    <div class="space-y-1">
                    ...
                    <div class="space-y-1">
                        <label class="text-[13px] text-slate-500">Interest (%) *</label>
                        <input type="number" name="interest_rate" step="0.01" placeholder="0.00" required class="w-full bg-white border border-slate-300 rounded-sm px-3 py-2 text-[13px] outline-none">
                    </div>
                    <div class="space-y-1">
                        <label class="text-[13px] text-slate-600">Semi-Monthly Amortization</label>
                        <input type="number" name="deduction" step="0.01" placeholder="0.00" readonly class="w-full bg-slate-50 border border-slate-400 rounded-sm px-3 py-2 text-[15px] font-bold text-slate-900 text-right outline-none">
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-4 mt-10 pt-6 border-t border-slate-100">
                ...
                <button type="submit" class="px-6 py-2 bg-red-600 text-white text-[12px] font-bold rounded-sm hover:bg-red-800 transition-colors">Next Step</button>
            </div>
        </form>
    </div>
</div>
...
public function getAllBorrowers($paginate = false, $page = 1, $limit = 50, $search = '', $fromDate = '', $toDate = '', $status = '') {
    ...
    $orderBy = "l.date_granted DESC";
        ...
        $selectCols = "
            ...
            l.void_reason as void_reason,
            l.void_reason as inactivate_reason,
            l.voided_at as voided_at,
            l.voided_at as inactivated_at,
            l.voided_by_employe_id,
            (SELECT CONCAT(u.first_name, ' ', u.last_name) FROM Users u WHERE u.employe_id = l.voided_by_employe_id LIMIT 1) as voided_by,
